...
public class FarmLogicTFC extends FarmLogicHomogeneous {

	public FarmLogicTFC(IFarmHousing housing) {
		super(housing, new ItemStack(Blocks.end_stone), new ItemStack(Blocks.end_stone), Farmables.farmables.get("farmTFC"));
	}
