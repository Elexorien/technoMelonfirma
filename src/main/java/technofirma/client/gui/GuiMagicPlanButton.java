...
public class GuiMagicPlanButton extends GuiButton 
{
	public ItemStack item;
	GuiMagicPlanSelection screen;
	protected static final RenderItem itemRenderer = new RenderItem();

	public GuiMagicPlanButton(int index, int xPos, int yPos, int width, int height, ItemStack ico, GuiMagicPlanSelection gui, String s)
	{
	...
	public void drawButton(Minecraft mc, int x, int y)
	{
		if (this.visible)
		{
			...
			TFC_Core.bindTexture(GuiMagicPlanSelection.texture);
