...
public class GuiMagicAnvilPlanButton extends GuiButton 
{
	GuiMagicAnvil screen;
	protected static final RenderItem itemRenderer = new RenderItem();

	public GuiMagicAnvilPlanButton(int index, int xPos, int yPos, int width, int height, GuiMagicAnvil gui, String s)
	{
