...
public class TETFIngotPile extends TEIngotPile implements IInventory
{
	...
	public TETFIngotPile()
	{
		storage = new ItemStack[1];
		type = "ThaumicSteel";
		INGOTS = new Item[] { TechnoItems.ThaumicSteelIngot };
	}
	...
	public void updateNeighbours()
	{
		if(worldObj.blockExists(xCoord, yCoord+1, zCoord) && !worldObj.isAirBlock(xCoord, yCoord+1, zCoord))
			worldObj.getBlock(xCoord, yCoord+1, zCoord).onNeighborBlockChange(worldObj, xCoord, yCoord+1, zCoord, TechnoItems.TFIngotPile);
	}
